            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>
								<div class="w3-container w3-theme">
									<h2>Exclusão do Professor Cód. = [<?php echo $row['Cod']; ?>]</h2>
								</div>
								<form class="w3-container" action="ProfExcluir_exe.php" method="post" onsubmit="return check(this.form)">
									<input type="hidden" id="Id" name="Id" value="<?php echo $row['Cod']; ?>">
									<p>
									<label class="w3-text-deep-purple"><b>Nome: </b> <?php echo $row['Nome']; ?> </label></p>
									<p>
									<label class="w3-text-deep-purple"><b>Número: </b><?php echo $row['Numero']; ?></label></p>
									<p>
									<label class="w3-text-deep-purple"><b>Data de Nascimento: </b><?php echo $nova_data; ?></label></p>
									<p>
									<label class="w3-text-deep-purple"><b>Acomodação: </b><?php echo $row['Acomod']; ?></label></p>
									<p>
