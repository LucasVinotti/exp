...
---------------------------------------------------------------------------------->
	...
	<div class="w3-top">
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:4;">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-white w3-padding-16" href="javascript:void(0)" onclick="w3_show_nav('menuProf')">Planos</a>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar">
		<div class="w3-bar w3-hide-large w3-large">
			<a href="javascript:void(0)" onclick="w3_show_nav('menuProf')"
			   class="w3-bar-item w3-button w3-theme w3-hover-white w3-padding-16" style="width:50%">Menu</a>
		</div>
		...
		<div id="menuProf" class="myMenu">
			...
			<a class="w3-bar-item w3-button" href="profListar.php">Planos Cadastrados</a>
			<a class="w3-bar-item w3-button" href="profContratar.php">Cadastrar Plano </a>
