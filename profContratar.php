...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xlarge">Cadastro de Plano</h1>
            ...
            <div class="w3-code cssHigh notranslate">
                ...
                <div class="w3-responsive w3-card-4">
                    ...
                    <form class="w3-container" action="ProfContratar_exe.php" method="post" onsubmit="return check(this.form)">
						...
						<p>
						<label class="w3-text-deep-purple"><b>Nome Beneficiário</b></label>
						...
						<p>
						<label class="w3-text-deep-purple"><b>Numero Plano</b></label>
						<input class="w3-input w3-border w3-light-grey " name="Numero" type="text"
							   title="(11)1111-1111." required></p>
						<p>
						...
						<p>
						<label class="w3-text-deep-purple"><b>Acomodação</b></label>
						<input class="w3-input w3-border w3-light-grey" name="Acomod" type="text"
							   title="Formato: nome.sobrenome" required></p> 
						<p>
